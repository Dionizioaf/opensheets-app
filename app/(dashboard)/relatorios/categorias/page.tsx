...
import type { CategoryOption, FilterState } from "@/components/relatorios/types";
...
export default async function Page({ searchParams }: PageProps) {
    ...
    if (!validation.isValid) {
        ...
        redirect(`/relatorios/categorias?inicio=${defaultStartPeriod}&fim=${currentPeriod}`);
    }
    ...
    const categoryOptions: CategoryOption[] = categoriaRows.map((cat: Categoria): CategoryOption => ({
        id: cat.id,
        name: cat.name,
        icon: cat.icon,
